  ...
  const links = (
    <>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="hover:text-white transition-colors flex items-center gap-1.5 px-2 py-2 min-h-[44px] rounded-md"
        aria-label="Threads 페이지 새 창 열기"
      >
