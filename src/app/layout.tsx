...
export const metadata: Metadata = {
  ...
  description: "코딩 경험 없는 비개발자를 위한 클로드 코드(Claude Code) 실전 교육. 노무 실무에 직접 적용하며 정리한 16단계 78개 강의로 터미널 기초부터 웹앱 배포까지 익힙니다.",
  ...
  openGraph: {
    ...
    description: "코딩 경험 없는 비개발자를 위한 클로드 코드 실전 강의. 터미널 여는 법부터 웹앱 배포까지 16단계 78개 강의.",
  },
  twitter: {
    card: "summary_large_image",
    title: "클로드 코드 실무 교육 | 현업 적용 중심 과정",
    description: "코딩 경험 없는 비개발자를 위한 클로드 코드 실전 강의. 16단계 78개 강의로 AI 업무 자동화.",
  },
  verification: {
    google: [
