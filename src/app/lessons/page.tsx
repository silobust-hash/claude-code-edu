const allLessons = [
  ...
  },
  {
    ...
    lessons: [
      { id: "4-1", title: "Claude in Excel — 엑셀 안에서 AI로 데이터 분석", status: "coming" },
      { id: "4-2", title: "Claude in PPT — 프레젠테이션을 AI가 함께 만든다", status: "coming" },
      { id: "4-3", title: "Claude for Chrome — 브라우저에서 바로 쓰는 AI 비서", status: "coming" },
      { id: "4-4", title: "실전: 임금대장 분석 + 강의 슬라이드 + 판례 요약 한번에", status: "coming" },
    ],
  },
  {
    phase: 5,
    ...
    lessons: [
      { id: "5-1", title: "스킬이란? — /명령어 하나로 복잡한 작업을 자동화", status: "coming" },
      { id: "5-2", title: "빌트인 스킬 활용 — /commit, /review-pr 등", status: "coming" },
      { id: "5-3", title: "커스텀 스킬 만들기 — 나만의 /임금계산, /취업규칙검토", status: "coming" },
      { id: "5-4", title: "스킬 체이닝 — 여러 스킬을 연결해 파이프라인 구축", status: "coming" },
    ],
  },
  {
    phase: 6,
    phaseTitle: "코워크 & 플러그인",
    lessons: [
      { id: "6-1", title: "코워크란? — Claude와 진짜 '협업'하는 방식", status: "coming" },
      { id: "6-2", title: "플러그인의 개념 — 전문 분야별 AI 확장 모듈", status: "coming" },
      { id: "6-3", title: "노무사 플러그인 실전 — 사건접수부터 문서검증까지", status: "coming" },
      { id: "6-4", title: "나만의 플러그인 설계 — 우리 사무실 맞춤 워크플로우", status: "coming" },
      { id: "6-5", title: "플러그인 조합 — 4대 법률 통합, 블로그 발행, 문서 검증", status: "coming" },
    ],
  },
  {
    phase: 7,
    ...
    lessons: [
      { id: "7-1", title: "MCP 서버란? 왜 노무사에게 필요한가", status: "coming" },
      { id: "7-2", title: "Gmail 연동 — 의뢰인 이메일 자동 분류", status: "coming" },
      { id: "7-3", title: "Google Calendar — 사건 기일 관리", status: "coming" },
      { id: "7-4", title: "Notion 연동 — 사건 데이터베이스 구축", status: "coming" },
    ],
  },
  {
    phase: 8,
    ...
    lessons: [
      { id: "8-1", title: "HTML/CSS/JS 기초 — Claude가 알려주니까 쉬워요", status: "coming" },
      { id: "8-2", title: "Next.js로 웹사이트 뚝딱 만들기", status: "coming" },
      { id: "8-3", title: "Vercel 배포 — 내가 만든 서비스를 세상에", status: "coming" },
      { id: "8-4", title: "실전: 노무 상담 접수 폼 만들어 배포하기", status: "coming" },
    ],
  },
  {
    phase: 9,
    ...
    lessons: [
      { id: "9-1", title: "리모트 컨트롤 — 폰에서도 Claude Code", status: "coming" },
      { id: "9-2", title: "Claude Code on Web — 클라우드에서 자동화", status: "coming" },
      { id: "9-3", title: "팀 워크플로우 — 사무실 전체가 AI와 협업", status: "coming" },
      { id: "9-4", title: "전체 파이프라인 완성 — 스킬+코워크+MCP 통합", status: "coming" },
    ],
  },
];
