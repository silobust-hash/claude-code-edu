...
export const metadata: Metadata = {
  title: "강의 목록",
  description: "클로드 코드 16단계 80강 전체 강의 목록 — Phase 1 AI 시대 이해하기부터 Phase 16 AI 시대를 읽고 구현하는 법까지, 실습 파일이 남는 비개발자 노무사 단계별 강의를 한눈에 확인하세요.",
    ...
    <div>
      <section className="relative overflow-hidden bg-ink-950 text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-6 pt-20 pb-16 text-center">
          <p className="eyebrow text-brand-300">LESSONS · 80개 강의</p>
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="border-gradient relative mt-16 rounded-2xl bg-white p-8 text-center shadow-sm">
          <h3 className="text-lg font-bold text-ink-900">전체 16단계, 80개 강의</h3>
