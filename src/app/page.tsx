...
const courseJsonLd = {
  ...
  description: "현업에서 직접 써보고 다듬은 비개발자용 클로드 코드 실무 교육. 터미널 여는 법부터 웹앱 배포까지 실행 로그 중심으로 배우는 16단계 78개 강의.",
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "총 16단계, 78개 강의로 약 70시간 분량입니다. 자기 페이스에 맞춰 진행할 수 있으며, Phase 1~3(기초)만 마쳐도 실무에 바로 적용할 수 있습니다.",
      },
    },
    {
      "@type": "Question",
