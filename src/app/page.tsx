...
const courseJsonLd = {
  ...
  description: "현업에서 직접 써보고 다듬은 비개발자용 클로드 코드 실무 교육. 터미널 여는 법부터 웹앱 배포까지 실행 로그 중심으로 배우는 16단계 79개 강의.",
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "16단계 과정을 완료하면 퇴직금·임금 자동 계산, 취업규칙 검토 자동화, 진정서·의견서 초안 작성, MCP로 Gmail·캘린더·노션 연동, 커스텀 스킬과 플러그인 개발, 그리고 나만의 웹앱을 만들어 배포하는 것까지 가능합니다.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "총 16단계, 79개 강의로 약 70시간 분량입니다. 자기 페이스에 맞춰 진행할 수 있으며, Phase 1~3(기초)만 마쳐도 실무에 바로 적용할 수 있습니다.",
      },
    },
    {
      "@type": "Question",
      ...
      <section className="mx-auto max-w-6xl px-6 py-24">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end" data-reveal>
          <div className="max-w-xl">
            ...
            <h2 className="display-sm mt-3 text-3xl md:text-4xl text-ink-900">16단계 커리큘럼</h2>
            <p className="mt-4 text-lg text-ink-500 balance">
