export const lessonsPhase7to8: Record<string, any> = {
  ...
  "9-4": {
    ...
    insights: [
      {
        heading: "코딩하는 노무사는 이제 현실이다",
        content:
          "저는 코딩 경험 없이 AI와 대화만으로 옵시디언 플러그인 강철중을 만들었습니다. 사이드바 채팅, API 연동까지 다 구현됐죠. 외주 개발비 없이 임금 계산기, 근로감독 체크리스트 앱, 서면 자동 생성기 같은 도구를 직접 만들 수 있는 시대입니다. 노무사 업계에서 이건 독보적인 차별화 포인트입니다.",
        source: "바이브코딩 완전정복 (2026)",
      },
    ],
    keyTakeaways: [
